...
function Longurl( {shorturl, longurl, setLongUrl, copyText, handleClick} ) {
  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <h1 className="text-center text-3xl">Enter Long URL</h1>
      <div className="mx-auto flex  items-center gap-2 my-10 ">
        ...
        {/* <span
            onClick={()=>{
            copyText(longurl)}}
            className="font-bold font-mono text-center bg-indigo-500 text-white text-md px-3 py-2 rounded-lg hover:cursor-pointer hover:bg-indigo-700 duration-300">
            <Clipboard /> 
        </span> */}
      </div>
